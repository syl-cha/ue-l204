...
\subsection{Mise en place de la page de connexion et de déconnexion}
...
\subsection{Gestion sécurisée de la base de données}
...
\subsection{Page d’accueil protégée}
La page \texttt{pages/accueil.php} n’est accessible que si l’utilisateur est connecté, sinon redirection automatique
\clearpage
\part{Bilan à mi-parcours}
