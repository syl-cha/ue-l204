...
<div class="admin-actions">
  <a class="btn" href="accueil.php?action=liste_cours" title="Lister tous les cours">Lister tous les cours</a>
  <a class="btn" href="accueil.php?action=liste_enseignements" title="Lister mes enseignements">Lister mes cours</a>
                ...
                <tr>
                  ...
                  <td>
                    <div class="actions">
                      ...
                      <?php else: ?>
                        <a href="accueil.php?action=inscription_cours&cours_id=<?= (int)$c['id'] ?>" class="btn btn-xs">S'inscrire</a>
                      <?php endif; ?>
                    </div>
                  </td>
                </tr>
          ...
          <tbody>
            <?php foreach ($coursDejaSuivis as $c): ?>
              <tr>
                ...
                <td>
                  <div class="actions">
                    <a href="accueil.php?action=desinscription_cours&cours_id=<?= (int)$c['id'] ?>"
