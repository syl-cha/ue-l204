...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($actionPost === 'delete_enseignant') {
    ...
    header('Location: accueil.php?action=liste_enseignants');
    exit;
  }
  ...
  if ($actionPost === 'delete_etudiant') {
    ...
    header('Location: accueil.php?action=liste_etudiants');
    exit;
  }
  ...
  if ($actionPost === 'save_enseignant') {
    ...
    if (!empty($errors)) {
      ...
      header('Location: accueil.php?action=edit_enseignant&id=' . $idEns);
      exit;
    }
  ...
  if ($actionPost === 'save_etudiant') {
    ...
    if (!empty($errors)) {
      ...
      header('Location: accueil.php?action=edit_etudiant&id=' . $idEtu);
      exit;
    }
  ...
  if ($actionPost === 'create_enseignant') {
    ...
    if (!empty($errors)) {
      ...
      header('Location: accueil.php?action=add_enseignant');
      exit;
    }
  ...
  if ($actionPost === 'create_etudiant') {
    ...
    if (!empty($errors)) {
      ...
      header('Location: accueil.php?action=add_etudiant');
      exit;
    }
